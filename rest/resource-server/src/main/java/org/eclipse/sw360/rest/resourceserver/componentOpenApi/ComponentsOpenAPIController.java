...
public class ComponentsOpenAPIController
        ...
        private HalResource<ComponentPG> createHalComponent(ComponentAPI sw360Component, User user)
                        throws TException {
        ...
        private CollectionModel getFilteredComponentResources(List<String> fields,
                        ...
                        PaginationResult<ComponentAPI> paginationResult)
        ...
        public ResponseEntity<CollectionModel<EntityModel<ComponentPG>>> getComponents(
                ...
                List<ComponentAPI> allComponents = componentService.listOAPIComponents(params);
                PaginationResult<ComponentAPI> paginationResult =
