...
public class VendorOpenAPIController
    ...
    public ResponseEntity<List<VendorPG>> getVendors(
            // public ResponseEntity<CollectionModel<EntityModel<VendorPG>>> getVendors(
        ...
        // PaginationResult<Vendor> paginationResult = restControllerHelper
        // .createPaginationResult(request, pageable, vendors, SW360Constants.TYPE_VENDOR);
        ...
        // } else {
        // resources =
        // restControllerHelper.generatePagesResource(paginationResult, vendorResources);
        // }
