...
public class ProjectsOpenAPIController
        ...
        public ResponseEntity<EntityModel<ProjectPG>> getProject(
                ...
                HalResource<ProjectPG> halProject = createHalProject(
                                projectServicePG.getProjectForUserById(id,
                                                restControllerHelper
                                                                .getSw360UserFromAuthentication()),
        ...
        private HalResource<ProjectPG> createHalProject(ProjectAPI sw360Project, User sw360User) {
                ProjectPG project = new ProjectPG(sw360Project);
                project.setComponents(List.of());

                HalResource<ProjectPG> halProject = new HalResource<>(project);

                List<ComponentPG> components = projectServicePG
                                .getComponentsForProject(sw360Project.getId(), sw360User);
