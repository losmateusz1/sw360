...
public class ReleaseOpenAPIController
        ...
        private HalResource<ReleasePG> createHalReleaseResource(ReleasePG release, boolean verbose)
                        throws TException {
                System.out.println("Creating HAL resource for release: " + release);
                System.out.println("Release Component DEBUG: " + release.getComponent());
                System.out.println("Release vulnerabilities DEBUG: "
                ...
                if (vulnerabilities != null && !vulnerabilities.isEmpty()) {
                        // List<VulnerabilityPG> vulnList =
                        // vulnerabilities.stream().map(vuln -> vuln).toList();
