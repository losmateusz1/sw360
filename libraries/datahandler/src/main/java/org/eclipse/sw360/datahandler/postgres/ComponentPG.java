...
public class ComponentPG extends ComponentAPI implements Serializable {
    ...
    // public List<VulnerabilityPG> getVulnerabilities() {
    // List<VulnerabilityPG> vulnerabilities = List.of();
    // if (releases != null && !releases.isEmpty()) {
    // for (ReleasePG release : releases) {
    // if (release.getVulnerabilityRelation() != null) {
    // vulnerabilities.addAll(release.getVulnerabilityRelation().stream()
    ...
    public ComponentPG(UUID id, String name, String revision, String description,
            ...
            String ownerCountry, VisibilityEnum visibility, String businessUnit,
